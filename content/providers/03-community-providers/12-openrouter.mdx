...
const chatModel = openrouter.chatModel('anthropic/claude-2');

// Completion models
const completionModel = openrouter.completionModel('meta-llama/llama-2-70b');
```
...
const { text } = await generateText({
  model: openrouter.chatModel('anthropic/claude-2'),
...
const result = streamText({
  model: openrouter.chatModel('google/gemini-pro'),
